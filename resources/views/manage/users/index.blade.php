                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="relative flex-shrink-0">
                                        <img src="{{ $user->avatar_url }}" alt="{{ $user->name }}" class="h-12 w-12 rounded-xl object-cover border-2 border-cyan-500/50 shadow-lg shadow-cyan-500/30 transition group-hover:scale-110 group-hover:shadow-cyan-500/50 group-hover:border-cyan-500">
                                        @if($user->id === auth()->id())
